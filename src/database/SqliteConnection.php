<?php
/**
 * This class extends the DatabaseConnection class to support connections to a SQLite database file.
 * This class may also implement SQLite-specific features.
 * 
 * @version 	$Id: PostgreSqlConnection.php 1547 2008-09-03 05:39:28Z anders $
 */
class SqliteConnection extends DatabaseConnection {
	private $database;
	protected $query_func        = 'sqlite_query';
	protected $error_func        = 'sqlite_last_error';
	protected $fetch_all_func    = 'sqlite_fetch_all';
	protected $fetch_row_func    = 'sqlite_fetch_row';
	//protected $affected_rows_func = 'sqlite_affected_rows';
