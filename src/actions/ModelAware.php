 ...
 * values from request parameters (or after a redirect from failed validation, the session).
 * The action must expose a public <code>$model</code> property which will hold the populated
 * model.
 * 
